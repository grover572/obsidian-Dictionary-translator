            ...
            >
              ...
              >
                <template #label>
                  ...
                  <n-button class="record-button" dashed size="tiny" @click="toggleRecording" :type="isRecording ? 'info' : ''">
                    <template #icon>
                      <n-icon>
                        <Mic/>
                      </n-icon>
                ...
                <n-radio-group v-model:value="saveData.speech" name="speechRadio">
                  <n-flex>
                    ...
                    <n-radio v-for="(speech,index) in selfSpeech" @click="speechPlay(speech)" :key="index"
                             :value="speech">
                      {{ `My Record ${index + 1}` }}
                    </n-radio>
                  </n-flex>
